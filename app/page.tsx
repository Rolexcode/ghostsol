export default function Home() {
  ...
  <div id="apparition" className="scroll-apparition" aria-hidden="true"><img src="/assets/alley.jpg" alt="" /></div>
